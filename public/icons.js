/* Icon set — Lucide path data (MIT), inlined for reliability.
   Exposes window.CRCIcon — an <Icon name size/> React component. */
(function () {
  const P = {
    ...
    "file-diff": '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M9 13h6"/><path d="M12 10v6"/><path d="M9 17h6"/>',
  ...
  function Icon({ name, size = 16, strokeWidth = 1.75, className = "", style = {}, ...rest }) {
    return React.createElement("svg", {
      ...
      className: "crc-ic " + className, style: { flex: "none", ...style },
      dangerouslySetInnerHTML: { __html: P[name] || "" }, ...rest,
    });
  }
  window.CRCIcon = Icon;
})();
